...
//   // Testing new anumations with scrollTrigger with gsap
//   // gsap.utils.toArray(".testing-animation").forEach(section => {
//   //   const w = section.querySelector(".wrapper");
//   //   const sectionWidth = section.offsetWidth;
//   //   const xStart = sectionWidth; // Start position off the screen to the right
//   //   const xEnd = 0; // End position, fully visible
...
//     });
//   gsap.utils
//     .toArray(".about-page-headings-animation")
//     .forEach((section, index) => {
//       const w = section.querySelector(".wrapper");

//       // Define starting and ending positions
//       const [x, xEnd] = ["430%", "0%"]; // Element starts off-screen to the right, animates to fully visible
...
//   gsap.utils.toArray(".animate-h1").forEach(element => {
//     gsap.fromTo(
//       element,
//       {
//         marginBottom: "32px",
...
//   // gsap.utils.toArray(".animate-div").forEach(element => {
//   //   gsap.fromTo(
//   //     element,
//   //     {
...
//   //     },
//   //     {
//   //       height: "auto", // Final height (auto to let content define height)
//   //       display: "block", // Remove flex centering
//   //       alignItems: "initial",
//   //       justifyContent: "initial",
//   //       scrollTrigger: {
//   //         trigger: outerDiv,
//   //         start: "top top", // Start the animation when the top of the outerDiv is at the top of the viewport
//   //         end: "bottom top", // End the animation when the bottom of the outerDiv is at the top of the viewport
//   //         scrub: 1 // Smooth scrubbing
//   //         // markers: true // Enable markers for debugging (remove this in production)
//   //       }
//   //     }
...
//   // gsap.utils.toArray(".h1-animation-test").forEach(element => {
//   //   const startX = () =>
...
//   //     element,
//   //     {
//   //       fontSize: "50px", // Initial font size
//   //       x: startX, // Center horizontally
//   //       opacity: 0 // Start with opacity 0
//   //     },
//   //     {
//   //       fontSize: "3rem", // Final font size, you can adjust this as needed
